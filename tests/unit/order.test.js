...
jest.mock('../../middleware/authMiddleware', () => ({
  ...
  designer: (req, res, next) => next(),
  production: (req, res, next) => next(),
}));
...
describe('Order Controller Unit Tests', () => {
  ...
  describe('POST /api/orders', () => {
    it('should create an order successfully', async () => {
      ...
      OrderLog.create.mockResolvedValue({});
  ...
  describe('GET /api/orders/:id', () => {
    it('should return order by ID for owner', async () => {
      ...
      Order.findById.mockReturnValue({
        ...
        then: jest.fn().mockImplementation((resolve) => resolve(mockOrder)),
        catch: jest.fn(),
      });
  ...
  describe('PUT /api/orders/:id/status', () => {
    function mockFindById(orderData) {
      const query = {
        populate: jest.fn().mockReturnThis(),
      };
      query.then = jest.fn().mockImplementation((resolve) => resolve(orderData));
      query.catch = jest.fn();
      return query;
    }
    ...
    it('should update order status as admin', async () => {
      ...
      Order.findById.mockReturnValue(mockFindById(mockOrder));
      Product.findOneAndUpdate.mockResolvedValue({
        stockPolos: 1100,
      });
    ...
    it('should return 404 for non-existent order', async () => {
      Order.findById.mockReturnValue(mockFindById(null));
